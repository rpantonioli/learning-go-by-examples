...
var getCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		// Initialize variable wwith default Gopher
		var gopherName = "dr-who.png"

		// Retrieves the gopher name passed in parameter
		if len(args) >= 1 && args[0] != "" {
			gopherName = args[0]
		}

		// Create URL of gopher
		...
		if response.StatusCode == 200 {
			...
			// The best practice is to add your closing statement
			// with a defer word right after your opening, so you don't forget it.
			defer out.Close()
